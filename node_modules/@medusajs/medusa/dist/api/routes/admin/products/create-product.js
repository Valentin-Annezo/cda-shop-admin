        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, entityManager.transaction(function (manager) { return __awaiter(void 0, void 0, void 0, function () {
                        var variants, shippingProfile, _a, _b, _c, i, variant, optionIds_1;
                        var e_1, _d;
                        var _e;
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 1:
                                    ...
                                    return [3 /*break*/, 4];
                                case 2: return [4 /*yield*/, shippingProfileService.retrieveDefault()];
                                case 3:
                                    shippingProfile = _f.sent();
                                    _f.label = 4;
                                ...
                                case 5:
                                    ...
                                    optionIds_1 = ((_e = validated === null || validated === void 0 ? void 0 : validated.options) === null || _e === void 0 ? void 0 : _e.map(function (o) { return newProduct.options.find(function (newO) { return newO.title === o.title; }).id; })) || [];
