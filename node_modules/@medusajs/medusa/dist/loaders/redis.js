...
function redisLoader(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var client, subscriber, client;
        return __generator(this, function (_b) {
            if (configModule.projectConfig.redis_url) {
                client = new ioredis_1.default(configModule.projectConfig.redis_url);
                subscriber = new ioredis_1.default(configModule.projectConfig.redis_url);
                container.register({
                    redisClient: (0, awilix_1.asValue)(client),
                    redisSubscriber: (0, awilix_1.asValue)(subscriber),
                });
            }
            else {
                ...
                container.register({
                    redisClient: (0, awilix_1.asValue)(client),
                    redisSubscriber: (0, awilix_1.asValue)(client),
                });
            }
            return [2 /*return*/];
        });
