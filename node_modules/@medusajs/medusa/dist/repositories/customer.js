...
var CustomerRepository = /** @class */ (function (_super) {
    ...
    CustomerRepository.prototype.listAndCount = function (query, q) {
        var _a;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (q) {
                            ...
                            qb.where(new typeorm_1.Brackets(function (qb) {
                        ...
                        if (groups) {
                            qb.leftJoinAndSelect("customer.groups", "group").andWhere("group.id IN (:...ids)", { ids: groups.value });
                        }
                        if ((_a = query.relations) === null || _a === void 0 ? void 0 : _a.length) {
                            query.relations.forEach(function (rel) {
                                qb.leftJoinAndSelect("customer.".concat(rel), rel);
                            });
                        }
