 ...
 * @extends BaseService
 */
declare class PriceListService extends TransactionBaseService<PriceListService> {
    ...
    constructor({ manager, customerGroupService, regionService, productService, productVariantService, priceListRepository, moneyAmountRepository, productVariantRepository, }: PriceListConstructorProps);
    /**
     ...
     */
    create(priceListObject: CreatePriceListInput): Promise<PriceList>;
    /**
