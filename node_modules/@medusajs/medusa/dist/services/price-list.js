    ...
    PriceListService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var priceListRepo, q, priceListSelector, _a, relations, query, groups;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        priceListRepo = manager.getCustomRepository(this.priceListRepo_);
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this.productService_.listAndCount(selector, config)];
                                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, this.variantService_.listAndCount(selector, config)];
                                    case 1:
