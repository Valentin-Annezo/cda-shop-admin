...
declare class SwapService extends SwapService_base {
    ...
    constructor({ manager, swapRepository, eventBusService, cartService, totalsService, returnService, lineItemService, paymentProviderService, shippingMethodTaxLineRepository, shippingOptionService, fulfillmentService, orderService, inventoryService, customShippingOptionService, lineItemAdjustmentService, }: {
        manager: any;
        swapRepository: any;
        eventBusService: any;
        cartService: any;
    ...
    private lineItemAdjustmentService_;
