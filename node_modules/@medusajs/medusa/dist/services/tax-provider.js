    ...
    TaxProviderService.prototype.clearTaxLines = function (cartId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        taxLineRepo = this.manager_.getCustomRepository(this.taxLineRepo_);
                        shippingTaxRepo = this.manager_.getCustomRepository(this.smTaxLineRepo_);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4:
                        itemTaxLineRepo = this.manager_.getCustomRepository(this.taxLineRepo_);
                        shippingTaxLineRepo = this.manager_.getCustomRepository(this.smTaxLineRepo_);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        toReturn = [];
                        return [4 /*yield*/, this.taxRateService_.listByShippingOption(optionId)];
                    case 2:
                        optionRates = _a.sent();
