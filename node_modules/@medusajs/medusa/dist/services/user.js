...
var UserService = /** @class */ (function (_super) {
     ...
     */
    UserService.prototype.validateEmail_ = function (email) {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        userRepo = transactionManager.getCustomRepository(this.userRepository_);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var userRepo, createData, validatedEmail, hashedPassword, created;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        userRepo = manager.getCustomRepository(this.userRepository_);
                                        createData = __assign({}, user);
                                        validatedEmail = this.validateEmail_(user.email);
    ...
    UserService.prototype.update = function (userId, update) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var userRepo, user, email, password_hash, metadata, rest, _a, _b, _c, key, value;
                            var e_1, _d;
