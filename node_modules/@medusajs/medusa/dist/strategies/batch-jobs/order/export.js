...
var _1 = require(".");
var batch_job_strategy_1 = require("../../../interfaces/batch-job-strategy");
...
var OrderExportStrategy = /** @class */ (function (_super) {
    ...
    function OrderExportStrategy(_a) {
        var fileService = _a.fileService, batchJobService = _a.batchJobService, orderService = _a.orderService, manager = _a.manager;
        var _this = 
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                                var batchJob, _a, writeStream, fileKey, promise, _b, _c, list_config, _d, filterable_fields, _e, count, lineDescriptor, header, orders;
                                var _this = this;
                                ...
                                return __generator(this, function (_s) {
                                    switch (_s.label) {
                                        ...
                                        case 3:
                                            ...
                                            _s.label = 4;
                                        case 4:
                                            if (!(offset < orderCount)) return [3 /*break*/, 9];
                                            return [4 /*yield*/, this.orderService_
                                                    .withTransaction(transactionManager)
                                        ...
                                        case 6:
                                            batchJob = (_s.sent());
                                            if (!(batchJob.status === batch_job_1.BatchJobStatus.CANCELED)) return [3 /*break*/, 8];
                                            writeStream.end();
                                            return [4 /*yield*/, this.fileService_
                                                    .withTransaction(transactionManager)
                                                    .delete({ key: fileKey })];
    ...
    OrderExportStrategy.prototype.buildHeader = function (lineDescriptor) {
        if (lineDescriptor === void 0) { lineDescriptor = _1.orderExportPropertiesDescriptors; }
    ...
    OrderExportStrategy.prototype.getLineDescriptor = function (fields, relations) {
        return _1.orderExportPropertiesDescriptors.filter(function (_a) {
...
}(batch_job_strategy_1.AbstractBatchJobStrategy));
