...
var useShippingOptions = function useShippingOptions(query, options) {
  ...
  var _useQuery = useQuery(shippingOptionKey.list(query), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
var useCartShippingOptions = function useCartShippingOptions(cartId, options) {
  ...
  var _useQuery2 = useQuery(shippingOptionKey.cart(cartId), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
...
var useAdminDeleteOrderMetadata = function useAdminDeleteOrderMetadata(id, options) {
  ...
  var queryClient = useQueryClient();
  return useMutation(function (key) {
...
var useAdminSetRegionMetadata = function useAdminSetRegionMetadata(id, options) {
  ...
  var queryClient = useQueryClient();
  return useMutation(function (metadata) {
